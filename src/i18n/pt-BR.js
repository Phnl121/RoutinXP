...
export const t = {
  ...
  admin: {
    ...
    funcoes: {
      ...
      descricoes: {
        ...
        agenda: 'Eventos e tarefas por dia, semana e mês, com lembretes.',
  ...
  agenda: {
    titulo: 'Agenda',
    modos: { rotulo: 'Período', dia: 'Dia', semana: 'Semana', mes: 'Mês' },
    anterior: { dia: 'Dia anterior', semana: 'Semana anterior', mes: 'Mês anterior' },
    proximo: { dia: 'Próximo dia', semana: 'Próxima semana', mes: 'Próximo mês' },
    hoje: 'Hoje',
    novo: 'Novo',
    novoRotulo: 'Criar evento ou tarefa',
    novoEvento: 'Evento',
    novoEventoDica: 'Compromisso com horário',
    novaTarefa: 'Tarefa',
    novaTarefaDica: 'Algo para fazer e concluir',
    mostrarTarefas: 'Tarefas',
    mostrarTarefasRotulo: 'Mostrar tarefas na agenda',
    carregando: 'Carregando a agenda…',
    erro: 'Não deu para carregar os eventos. Confira sua internet.',
    tentar: 'Tentar de novo',
    diaTodo: 'Dia todo',
    legenda: { rotulo: 'Legenda', evento: 'Evento', tarefa: 'Tarefa marcada', prazo: 'Prazo de tarefa' },
    prazo: 'Prazo',
    prazoRotulo: (titulo) => `Prazo da tarefa: ${titulo}`,
    tarefaRotulo: (titulo, horario) => `Tarefa: ${titulo}${horario ? `, ${horario}` : ''}`,
    eventoRotulo: (titulo, horario) => `Evento: ${titulo}${horario ? `, ${horario}` : ', dia todo'}`,
    concluir: (titulo) => `Concluir: ${titulo}`,
    concluida: 'concluída',
    mais: (n) => `+${n}`,
    maisRotulo: (n, dia) => `Ver mais ${n} ${n === 1 ? 'item' : 'itens'} de ${dia}`,
    abrirDia: (dia) => `Abrir ${dia}`,
    novoNoHorario: (dia, hora) => `Novo evento em ${dia} às ${hora}`,
    vazioDia: 'Nada marcado para este dia.',
    vazioSemana: 'Nada marcado nesta semana.',
    agora: 'Agora',
    continua: 'continua',
    repete: 'repete',
    evento: {
      novoTitulo: 'Novo evento',
      editarTitulo: 'Editar evento',
      titulo: 'Título',
      tituloExemplo: 'Ex.: Reunião com o orientador',
      diaTodo: 'Dia todo',
      inicio: 'Início',
      fim: 'Término',
      data: 'Data',
      hora: 'Hora',
      local: 'Local',
      localExemplo: 'Sala, endereço ou link da reunião',
      categoria: 'Categoria',
      semCategoria: 'Sem categoria',
      repeticao: 'Repetição',
      repeticoes: { nao: 'Não se repete', diaria: 'Todo dia', semanal: 'Toda semana', mensal: 'Todo mês', anual: 'Todo ano' },
      repetirAte: 'Até',
      repetirAteDica: 'Em branco: sem data para acabar.',
      lembrete: 'Lembrete',
      lembretes: { sem: 'Sem lembrete', 0: 'Na hora', 10: '10 minutos antes', 30: '30 minutos antes', 60: '1 hora antes', 1440: '1 dia antes' },
      lembreteDiaTodo: 'No dia todo, o lembrete conta a partir das 9h.',
      lembreteAtivar: 'Para receber o aviso neste aparelho, ative as notificações.',
      lembreteBloqueado: 'As notificações estão bloqueadas neste navegador. Libere nas configurações do site.',
      lembreteIphone: 'No iPhone, o aviso só chega com o app instalado na tela inicial.',
      ativar: 'Ativar avisos',
      descricao: 'Descrição',
      descricaoExemplo: 'Pauta, o que levar, detalhes…',
      salvar: 'Salvar',
      criar: 'Criar evento',
      salvando: 'Salvando…',
      cancelar: 'Cancelar',
      excluir: 'Excluir evento',
      excluirSoEste: 'Excluir só este dia',
      excluirTodos: 'Excluir todas as repetições',
      excluirPergunta: 'Este evento se repete. O que excluir?',
      voltar: 'Voltar',
      fimAntes: 'O término precisa ser depois do início.',
      longoDemais: 'Um evento pode durar no máximo 1 ano.',
      ateAntes: 'A repetição precisa acabar depois do primeiro dia.',
      repeticaoAviso: 'Editar muda todas as repetições.',
      excluido: (titulo) => `${titulo} excluído.`,
      salvo: (titulo) => `${titulo} salvo na agenda.`,
    },
  },
  ...
  formTarefa: {
    ...
    categoria: 'Categoria',
    data: 'Prazo',
    dataDica: 'Data limite. Concluir até ela rende +5 XP.',
    quando: 'Quando fazer',
    quandoDica: 'O dia (e, se quiser, o horário) em que você pretende fazer. Aparece na Agenda.',
    quandoDia: 'Dia',
    quandoInicio: 'Das',
    quandoFim: 'Até',
    quandoLimpar: 'Tirar da agenda',
    quandoFimAntes: 'O horário final precisa ser depois do inicial.',
    criar: 'Criar tarefa',
    salvar: 'Salvar',
    salvando: 'Salvando…',
    cancelar: 'Cancelar',
