...
- pt-BR copy, centralized in src/i18n/pt-BR.js. Product name: Routin. XP per task is undecided: never promise a fixed amount; the demo uses varied example values (+15, +5, +10).
